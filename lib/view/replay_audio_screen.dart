...
class ReplayAudio extends StatefulWidget {
  Color couleur;
   ReplayAudio({required this.couleur});

  @override
  _ReplayAudioState createState() => _ReplayAudioState();
}

class _ReplayAudioState extends State<ReplayAudio> {
  ...
  void initState() {
    ...
    fetchDataAll(c.Audiotheques[0].feedUrl);
                                      ...
                                      children: [
                                                Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Image.asset('assets/images/microphone.png',height: 20,width: 20,color: couleur,),
                                                  )
                                                ),
                                        ...
                                        Expanded(
                                            child: Container(
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsets.all(12.0),
                                                child: Image.asset('assets/images/play.png',height: 20,width: 20,color: couleur,),
                                              ),
                                            )
                                        ),
                                      ],
